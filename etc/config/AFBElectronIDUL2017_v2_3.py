...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.AFB['amcUL2017_pufix'].clone(),
    'mcAlt'  : tnpSamples.AFB['mgUL2017_pufix'].clone(),
    'tagSel' : tnpSamples.AFB['amcUL2017_pufix'].clone(),
}
...
baseOutDir = 'results/AFBElectronIDUL2017_v2_3/'
