...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.AFB['mgUL2017_pufix'].clone(),
    'mcAlt'  : tnpSamples.AFB['amcUL2017_pufix'].clone(),
    'tagSel' : tnpSamples.AFB['mgUL2017_pufix'].clone(),
}
samplesDef['tagSel'].rename('mcAltSel_'+samplesDef['tagSel'].name)
samplesDef['tagSel'].set_cut('tag_Ele_pt > 37')

baseOutDir = 'results/AFBElectronTriggerUL2017_v2_3/'
...
additionalCutBase = {
    ...
    'Ele32noL1DoubleEG_MediumID_QPlus' : 'el_pt > 24 && el_q > 0 && passingCutBasedMedium94XV2 == 1',
...
flags = {
    ...
    'Ele32noL1DoubleEG_MediumID_QPlus' : '(passHltEle32DoubleEGWPTightGsf == 1) && (passEGL1SingleEGOr==1)',
...
fine_pt_bin=[
    ...
    { 'var' : 'el_pt' , 'type': 'float', 'bins': [10, 15, 20, 24, 26, 27, 28, 29, 30, 31, 32, 33, 35, 40, 45, 70, 100, 500] },
]
...
flagBinningDef={
    ...
    'Ele32noL1DoubleEG_MediumID_QPlus':fine_pt_bin_32,
}
