...
samplesDef = {
    'data'   : tnpSamples.AFB['dataUL2017_official'].clone(),
    'mcNom'  : tnpSamples.AFB['mgUL2017_official'].clone(),
    'mcAlt'  : tnpSamples.AFB['amcUL2017_official'].clone(),
    'tagSel' : tnpSamples.AFB['mgUL2017_official'].clone(),
}
samplesDef['tagSel'].rename('mcAltSel_'+samplesDef['tagSel'].name)
samplesDef['tagSel'].set_cut('tag_Ele_pt > 37')

baseOutDir = 'results/AFBElectronTriggerUL2017_v2/'
