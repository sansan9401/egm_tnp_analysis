...
samplesDef['tagSel'].set_cut('tag_Ele_pt > 40 && '+tight_mcTrue)

baseOutDir = 'results/AFBElectronIDUL2017_v3/'
tnpTreeDir = 'tnpEleIDs'
cutBase   = 'tag_Ele_pt > 38 && abs(tag_sc_eta) < 2.1 && el_q*tag_Ele_q < 0'
additionalCutBase = {
