...
samplesDef = {
    'data'   : tnpSamples.AFB['dataUL2016postVFP'].clone(),
    'mcNom'  : tnpSamples.AFB['mgUL2016postVFP'].clone(),
    'mcAlt'  : tnpSamples.AFB['amcUL2016postVFP'].clone(),
    'tagSel' : tnpSamples.AFB['mgUL2016postVFP'].clone(),
}
samplesDef['tagSel'].rename('mcAltSel_'+samplesDef['tagSel'].name)
samplesDef['tagSel'].set_cut('tag_Ele_pt > 35')

baseOutDir = 'results/AFBElectronTriggerUL2016postVFP_v3/'
tnpTreeDir = 'tnpEleTrig'
cutBase   = 'tag_Ele_pt > 30 && el_q*tag_Ele_q < 0'
additionalCutBase = {
