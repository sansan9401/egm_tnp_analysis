...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.AFB['amcUL2017_official'].clone(),
    'mcAlt'  : tnpSamples.AFB['mgUL2017_official'].clone(),
    'tagSel' : tnpSamples.AFB['amcUL2017_official'].clone(),
}
...
baseOutDir = 'results/AFBElectronIDUL2017_v2/'
