...
samplesDef = {
    'data'   : tnpSamples.AFB['dataUL2017_TagEle32'].clone(),
    'mcNom'  : tnpSamples.AFB['mgUL2017_TagEle32'].clone(),
    'mcAlt'  : tnpSamples.AFB['amcUL2017_TagEle32'].clone(),
    'tagSel' : tnpSamples.AFB['mgUL2017_TagEle32'].clone(),
}
