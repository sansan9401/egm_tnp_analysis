...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.AFB['miUL2016postVFP'].clone(),
    'mcAlt'  : tnpSamples.AFB['mgUL2016postVFP'].clone(),
    'tagSel' : tnpSamples.AFB['miUL2016postVFP'].clone(),
}
samplesDef['tagSel'].rename('mcAltSel_'+samplesDef['tagSel'].name)
samplesDef['tagSel'].set_cut('tag_Ele_pt > 35')
additionalCuts={}

baseOutDir = 'results/AFBElectronTriggerUL2016postVFP_v3_5/'
