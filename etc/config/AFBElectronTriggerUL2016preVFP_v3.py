...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.AFB['mgUL2016preVFP'].clone(),
    'mcAlt'  : tnpSamples.AFB['amcUL2016preVFP'].clone(),
    'tagSel' : tnpSamples.AFB['mgUL2016preVFP'].clone(),
}
samplesDef['tagSel'].rename('mcAltSel_'+samplesDef['tagSel'].name)
samplesDef['tagSel'].set_cut('tag_Ele_pt > 35')

baseOutDir = 'results/AFBElectronTriggerUL2016preVFP_v3/'
